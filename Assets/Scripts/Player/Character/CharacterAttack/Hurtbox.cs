...
public class Hurtbox : MonoBehaviour
{
    ...
    /// <summary>
    /// Impacts recus recemment, conserves uniquement pour l'affichage des gizmos. La liste n'est alimentee que dans l'editeur : hors editeur, l'abonnement n'a jamais lieu (voir SubscribeHitGizmo) et elle reste donc vide.
    /// </summary>
